...
export const QUOTATION_STATUS_TRANSITIONS: Record<QuotationStatus, QuotationStatus[]> = {
  [QuotationStatus.DRAFT]: [QuotationStatus.REVIEW, QuotationStatus.APPROVED, QuotationStatus.REJECTED],
  [QuotationStatus.REVIEW]: [QuotationStatus.DRAFT, QuotationStatus.APPROVED, QuotationStatus.REJECTED],
